...
/**
 * PROPUESTA 2: Post-it Clásico con Sombra Realista
 * Diseño tipo post-it real con sombra sutil y esquina doblada
 */
...
export default function StickyNoteV2(props: CommonElementProps) {
  const {
    id,
    content,
    properties,
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background: `linear-gradient(135deg, transparent 0%, transparent 45%, ${currentColor.bg}dd 45%, ${currentColor.bg}dd 100%)`,
            clipPath: 'polygon(100% 0, 100% 12px, calc(100% - 12px) 0)',
          }}
        />
        ...
        {(isHovered || isSelected) && (
          <div className="absolute top-2 right-2 flex items-center gap-1 z-10">
            <div className="drag-handle cursor-grab active:cursor-grabbing p-1 rounded hover:bg-black/5">
              <GripVertical className="h-3 w-3 text-gray-500 opacity-50" />
            </div>
            <Button
              variant="ghost"
              size="icon"
