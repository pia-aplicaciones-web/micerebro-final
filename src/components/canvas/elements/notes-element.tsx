...
export default function NotesElement(props: CommonElementProps) {
  ...
  // Cambiar color de fondo (rueda cromática)
  const handleChangeColor = useCallback((color: { hex: string }) => {
    const hex = color.hex || backgroundColor;
  ...
  }, [id, onUpdate, properties, backgroundColor]);
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button
                ...
                size="icon"
                className="h-6 w-6 hover:bg-black/10 p-0"
                title="Rueda cromática - cambiar color de fondo"
                style={{ color: '#000000' }}
              >
            ...
            <PopoverContent
              ...
              className="w-auto p-0 border-none bg-transparent shadow-xl rounded-xl overflow-hidden"
            >
              <ChromePicker
