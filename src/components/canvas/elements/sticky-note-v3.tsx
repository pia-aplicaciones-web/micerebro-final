...
/**
 * PROPUESTA 3: Card Moderno Elegante
 * Diseño tipo card moderno con bordes suaves y sombra elegante
 */
      ...
      >
        ...
        {(isHovered || isSelected) && (
          <div className="absolute top-2 right-2 flex items-center gap-1 z-10">
            <div className="drag-handle cursor-grab active:cursor-grabbing p-1.5 rounded-md hover:bg-white/40 transition-colors">
              <GripVertical className="h-3.5 w-3.5 text-gray-600 opacity-60" />
            </div>
            <Button
              variant="ghost"
              size="icon"
              className="close-btn h-7 w-7 p-0 hover:bg-red-50 rounded-md transition-colors"
              onClick={handleClose}
        ...
        {/* Content Area */}
        {!minimized && (
          <div className="relative w-full h-full p-5 pt-7">
            <div
              ref={editorRef}
